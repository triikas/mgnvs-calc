...
def main(page: ft.Page):
    ...
    h_weight = ft.Text("Платный вес", size=50)
    h_res = ft.Text("Результат", size=50)

    paid_weight = 0
    res = 0

    txt_weight = ft.Text(str(paid_weight), size=30, color=mgnvs_red)
    txt_res = ft.Text(str(res), size=30, color=mgnvs_red)
